...
class RemoteConfigService {
  ...
  double get fhTargetSavingRatio {
    try {
      return double.tryParse(_remoteConfig.getString('fh_target_saving_ratio')) ?? 0.20;
    } catch (_) {
      return 0.20;
    }
  }
  ...
  double get fhTargetDebtRatio {
    try {
      return double.tryParse(_remoteConfig.getString('fh_target_debt_ratio')) ?? 0.35;
    } catch (_) {
      return 0.35;
    }
  }
  ...
  double get fhTargetEmergencyMonths {
    try {
      return double.tryParse(_remoteConfig.getString('fh_target_emergency_months')) ?? 3.0;
    } catch (_) {
      return 3.0;
    }
  }
  ...
  String get fhAiPromptTemplate => _remoteConfig.getString('fh_ai_prompt_template');

  String get fhShareToastMessage => _remoteConfig.getString('fh_share_toast_message');
  ...
  String get chatAiSystemInstruction => _remoteConfig.getString('chat_ai_system_instruction');
}
